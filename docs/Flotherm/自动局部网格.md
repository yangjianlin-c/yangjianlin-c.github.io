This feature uses the geometry, user applied grid constraints and overall system grid settings to automatically create the localized regions from version 2020.2.
